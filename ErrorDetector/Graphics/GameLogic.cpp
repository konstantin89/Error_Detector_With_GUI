...
GameLogic::GameLogic(bool fullScreen )
{
	/*sf::Style style;
	fullScreen ? style = sf::Style::Fullscreen : sf::Style::Default;*/
	const std::vector< sf::VideoMode>& vidddd = sf::VideoMode::getFullscreenModes();
    if(fullScreen)
    {
			g_WINDOW_SIZE = vidddd[0].height;
        ...
        //GameLogic::window->setPosition(sf::Vector2i(-100,-100));
