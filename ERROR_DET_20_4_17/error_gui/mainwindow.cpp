    ...
    ui(new Ui::MainWindow)
{
    ...
    //ui->tabWidget;//setBaseSize(p.width(), p.height());
    p.hide();//
}
...
void MainWindow::setUIParams(){
    ...
    ui->comboBox_patterns->setCurrentIndex(testParams.rectPatternId);
}
...
void MainWindow::setFileParams()
{
    ...
    testParams.rectPatternId = ui->comboBox_patterns->currentIndex();
}
