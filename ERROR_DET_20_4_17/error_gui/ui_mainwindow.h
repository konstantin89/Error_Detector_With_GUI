...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        frame->setGeometry(QRect(0, 0, 1211, 481));
        ...
        gridLayout_6->setContentsMargins(500, -1, 10, 60);
        ...
        gridLayout_6->addWidget(label_2, 4, 1, 1, 1);

        pushButton_stop = new QPushButton(frame);
        pushButton_stop->setObjectName(QString::fromUtf8("pushButton_stop"));

        gridLayout_6->addWidget(pushButton_stop, 8, 2, 1, 1);

        playButton = new QPushButton(frame);
        playButton->setObjectName(QString::fromUtf8("playButton"));
        playButton->setFocusPolicy(Qt::NoFocus);

        gridLayout_6->addWidget(playButton, 8, 1, 1, 1);
        ...
        user_name_field->setAutoFillBackground(true);
        ...
        comboBox_patterns = new QComboBox(groupBox);
        comboBox_patterns->setObjectName(QString::fromUtf8("comboBox_patterns"));
        comboBox_patterns->setGeometry(QRect(10, 30, 141, 21));

        gridLayout_6->addWidget(groupBox, 3, 1, 1, 1);
        ...
        gridLayout_6->addWidget(groupBox_3, 4, 2, 2, 1);

        gridLayout_6->setRowStretch(0, 1);
        gridLayout_6->setRowStretch(1, 2);
        gridLayout_6->setRowStretch(2, 3);
        gridLayout_6->setRowStretch(3, 4);
        gridLayout_6->setRowStretch(4, 5);
        gridLayout_6->setRowStretch(5, 6);
...
"to continue click 'NEXT'. ", 0, QApplication::UnicodeUTF8));
        ...
        groupBox->setTitle(QApplication::translate("MainWindow", "Choose pattern:", 0, QApplication::UnicodeUTF8));
        comboBox_patterns->clear();
        comboBox_patterns->insertItems(0, QStringList()
         << QApplication::translate("MainWindow", "pattern 1", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("MainWindow", "pattern 2", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("MainWindow", "pattern 3", 0, QApplication::UnicodeUTF8)
        );
        //comboBox_patterns->setCurrentText(QApplication::translate("MainWindow", "pattern 1", 0, QApplication::UnicodeUTF8));
        ...
        plainTextEdit_2->setPlainText(QApplication::translate("MainWindow", "You are about to start a calibration operation -\n"
